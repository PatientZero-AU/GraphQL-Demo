...
import { Client } from './shared/api/client.service';
...
export class AppComponent implements OnInit {
  ...
  async login() {
    await this._apiClient.apiAccountLoginPost('kermit').first().toPromise();
  }

  async logout() {
    await this._apiClient.apiAccountLogoutPost().first().toPromise();
  }
}
